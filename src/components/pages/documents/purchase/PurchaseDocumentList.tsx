...
export const PurchaseDocumentList: ComponentType<RouteComponentProps & RP<any>> = (props) => (
    <List<PurchaseDocument, Item, any> 
        ...
        fetchApiOptions={{route: "Plataforma/Listas/CarregaLista/adhoc?listId=7EA25455-2587-EB11-81AF-706655E33B46&listParameters=2999-12-12,1800-01-01,%%,%%,%%,99999,0,%%,%%,%%", credentials: 'include'}}
        fields={[ 
        {
            label: "Data",
            xfield: "Data",
